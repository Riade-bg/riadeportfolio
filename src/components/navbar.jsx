    ...
    return (
        <>
            <nav className="fixed w-full top-0 flex flex-1 justify-between items-center px-10 py-5 shadow-lg bg-[#09192e]/40 backdrop-blur z-20">
                <div>
                    <h1 className="px-3 py-1 text-white border-2 border-white text-lg font-bold">
                        R
                    </h1>
                </div>
                <ul className="flex text-gray-300 text-sm font-work items-center">
                    {[
                        ...
                        <li
                            key={index}
                            className="hover:text-sky-500 mr-10 capitalize hidden md:flex items-center transition-all"
                        >
                    ...
                    <li>
                        <a
                            href={Resume}
                            download
                            className="hidden md:flex px-5 py-2 text-sm text-sky-300 rounded border border-sky-300 
