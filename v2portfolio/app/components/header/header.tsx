    ...
    return(
      <>
        <div className='px-10 md:px-40 h-screen md:h-[655px] flex flex-col justify-center items-start'>
            <span className="mb-10 font-fira text-lg">Hi, my name is</span>
        ...
        after:absolute after:h-20 after:w-[0.5px] after:bg-white after:bottom-0 after:left-3">
            <p className="hover:text-sky-500 transition-all cursor-pointer mb-5">
                <AiFillGithub size={26} />
            </p>
            <p className="hover:text-sky-500 transition-all cursor-pointer mb-10">
        ...
        after:absolute after:h-20 after:w-[0.5px] after:bg-white after:bottom-0 after:right-28">
            <p className="hover:text-sky-500 transition-all cursor-pointer rotate-90">
                riadeboughaba<span className="text-sky-700 mx-1">@</span>gmail.com
            </p>
        </div>
      </>
    )
